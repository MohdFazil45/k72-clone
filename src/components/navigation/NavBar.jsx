...
const NavBar = () => {
  ...
  return (
    <div className=' flex fixed top-0 w-full items-start justify-between z-10'>
        <div className='h-24 w-36 p-2'>
            <svg className='w-full font-extrabold' fill="white" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 103 44">
        ...
        <div 
         ...
         onMouseLeave={() => {
          ...
          className="relative h-12 w-44 bg-black">
