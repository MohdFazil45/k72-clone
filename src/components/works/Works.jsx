const Works = ({ image1, image2 }) => {
  return (
    <>
      <div className=" lg:w-1/2 w-full group  h-full relative hover:rounded-4xl overflow-hidden transition-all">
      ...
      <div className="group relative lg:w-1/2 w-full h-full hover:rounded-4xl overflow-hidden bg-blue-500 ">
